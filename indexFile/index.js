...
let questions = [
  [
    ...
    {
      question: "ما هي الكلمة التي تشير إلى الاختبارات والتجارب التي يمر بها المسلمون في الحياة والتي تؤدي إلى تنقية الروح؟",
  ...
  [
    {
      ...
      options: ["10", "11", "12", "13"],
      correctAnswer: "12",
      hints: ["It's the sum of 5 and 7.", "You can count on your fingers to find the answer."]
    },
    {
      question: "What is 8 multiplied by 4?",
      options: ["24", "28", "32", "36"],
      correctAnswer: "32",
      hints: ["It's the result of repeated addition.", "Think of 8 added to itself 4 times."]
    },
    {
      question: "If you have 15 apples and you eat 3 of them, how many apples do you have left?",
      options: ["10", "11", "12", "13"],
      correctAnswer: "12",
      hints: ["Start with 15 apples.", "Subtract the number you ate to find the answer."]
    },
    {
      question: "What is 20 divided by 4?",
      options: ["4", "5", "6", "7"],
      correctAnswer: "5",
      hints: ["It's the result of sharing 20 equally among 4 groups.", "Think of how many are in each group."]
    },
    {
      question: "If you have a square with a side length of 6 units, what is its area?",
      options: ["24", "30", "36", "42"],
      correctAnswer: "36",
      hints: ["The area of a square is calculated by multiplying its side length by itself.", "Area = side length × side length."]
    }
  ],[
    {
    ...
    {
      question: "ما هو الثورة التي أدت إلى استقلال الولايات المتحدة عن بريطانيا؟",
      options: [
        "الثورة الفرنسية",
    ...
    {
      question: "ما هو الحدث التاريخي الذي وقع في 1969 عندما هبط أول رجل على سطح القمر؟",
      options: [
        "هبوط أبولو 11",
        "غزو أبولو 13",
        "إطلاق سبوتنيك",
    ...
    {
      question: "ما هو الثورة التي قادها مارتن لوثر كينغ للمطالبة بحقوق المواطنين الأمريكيين من أصل أفريقي؟",
      options: [
        "الحركة النسوية",
        "حركة الحقوق المدنية",
        "الحركة الانفصالية",
    ...
    {
      question: "في أي عام أعلنت الولايات المتحدة الأمريكية استقلالها عن بريطانيا؟",
      options: [
        "1776",
        "1865",
        "1492",
    ...
    {
      question: "ما هو التمييز بين الحروف الزائدة والحروف المفردة في اللغة العربية؟",
      options: [
    ...
    {
      question: "ما هو الكلمة الوحيدة في الجملة التالية: 'ذهب الولد إلى المدرسة.'؟",
      options: [
        "الولد",
        "إلى",
        "المدرسة",
